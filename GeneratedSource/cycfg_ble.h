...
#define CY_BLE_CONFIG_GAP_SECURITY_LEVEL            (0x02u)
...
#define CY_BLE_GATT_DB_MAX_VALUE_LEN                (0x0007u)
...
#define CY_BLE_GATT_DB_ATT_VAL_LEN_COUNT            (0x06u)
...
<Configuration major="1" minor="1" device="PSoC6">
                ...
                <ProfileRole type="Server">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{558bf6b5-27c4-47e7-82ec-5aefcc90b409}"/>
                            ...
                            <Characteristics>
                                <Characteristic type="org.bluetooth.characteristic.gap.device_name">
                                    ...
                                    <Permission>
                                        ...
                                        <Property id="AuthenticationPermissionWrite" value="AuthenticationRequired"/>
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{b22fd05f-7a77-41bb-a138-ad2975518002}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                                <Property id="IncludedServices" value="{299807b6-276a-44ee-8a77-48d28d6e2657}"/>
                            </ServiceProperties>
                            <Characteristics/>
                        </Service>
                        <Service type="org.bluetooth.service.immediate_alert">
                            <ServiceProperties>
                                <Property id="EntityID" value="{299807b6-276a-44ee-8a77-48d28d6e2657}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics>
                                <Characteristic type="org.bluetooth.characteristic.alert_level">
                                    ...
                                    <Permission>
                                        ...
                                        <Property id="AuthenticationPermissionRead" value="AuthenticationRequired"/>
                                        <Property id="AuthorizationPermissionRead" value="NoAuthorizationRequired"/>
                        ...
                        <Service type="org.bluetooth.service.battery_service">
                            <ServiceProperties>
                                <Property id="EntityID" value="{06c1ae75-2bf6-4b68-9f8c-a2791c8c1778}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics>
    ...
    <GAP>
        <General>
            ...
            <Property id="DeviceName" value="bunty"/>
        ...
        <SecurityConfigurations>
            <SecurityProperties>
                ...
                <Property id="SecurityLevel" value="Authenticated"/>
